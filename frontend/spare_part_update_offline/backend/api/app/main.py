...
from .models import spare_part, image, requisition_log, user, inbound_log, outbound_log  # 关键！必须导入模型
from .models import mechanical_spare_part, mechanical_spare_part_image, mechanical_requisition_log, mechanical_inbound_log, mechanical_outbound_log
