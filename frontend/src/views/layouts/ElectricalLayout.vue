  ...
  <div class="electrical-layout">
    ...
    <div v-if="!isMobile" class="sub-nav">
      <el-menu
        ...
        class="sub-menu"
      >
        <el-menu-item v-if="authStore.hasElectricalScope && !authStore.isElectricalClerk" index="/electrical/parts">电气设备</el-menu-item>
        <el-menu-item v-if="authStore.hasElectricalScope" index="/electrical/requisition">电气领用</el-menu-item>
        <el-menu-item v-if="authStore.hasElectricalScope && (authStore.canManageElectrical || authStore.isElectricalClerk)" index="/electrical/inventory">库存管理</el-menu-item>
        <el-menu-item v-if="authStore.hasElectricalScope && !authStore.isElectricalClerk" index="/electrical/operation-logs">记录查询</el-menu-item>
        <el-menu-item v-if="authStore.canManageElectrical" index="/electrical/users">用户管理</el-menu-item>
        <el-menu-item v-if="authStore.hasElectricalScope" index="/electrical/reports">报表统计</el-menu-item>
      </el-menu>
    </div>
...
const activeMenu = computed(() => route.path || '/electrical/parts')
